...
public class CustomViewBehind extends ViewGroup {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mSecondaryContent != null)
			mSecondaryContent.layout(0, 0, width, height-mHeightOffset);
	}
	...
	public void setShadowDrawable(Drawable shadow) {
		...
		mShadowDrawable.setVisible(false, false);
		invalidate();
	}
	...
	public void drawShadow(View content, Canvas canvas) {
		...
		mShadowDrawable.setBounds(0, top-mShadowWidth, getWidth(), top);
	...
	public void drawFade(View content, Canvas canvas, float openPercent) {
		...
		final int margin = (int) (1 * 40 * Math.abs(1-openPercent));
		final int alpha = (int) (1 * 255 * Math.abs(1-openPercent));
		...
		int bottom = 0;
		if (mMode == SlidingMenu.LEFT) {
			top = content.getTop()-getBehindHeight();
		...
		//if(ex_margin-margin>=0.5||ex_margin-margin<=-0.5){
...
//			
		//���� ���� �ִϸ��̼����� �ٲ㺸�������� 
//	        Log.e("Margin_val", "1");
//			setMargins(view_back, margin);
//	        Log.e("Margin_val", "1");
//			ex_margin = margin;
		//}
		canvas.drawRect(0, top, content.getWidth(), bottom, mFadePaint);
	}
	...
	public void drawSelector(View content, Canvas canvas, float openPercent) {
		...
		if (mSelectorDrawable != null && mSelectedView != null) {
			...
			if (tag.equals(TAG+"SelectedView")) {
				canvas.save();
				int left, right,top,bottom, offset;
				offset = (int) (mSelectorDrawable.getHeight() * openPercent);
				if (mMode == SlidingMenu.LEFT) {
					top = content.getTop();
					bottom = top - offset;
					canvas.clipRect(0, top, 0, bottom);
					canvas.drawBitmap(mSelectorDrawable, top, getSelectorTop(), null);		
				} else if (mMode == SlidingMenu.RIGHT) {
					left = content.getRight();
					right = left + offset;
	...
	public void setMarginLay(View v) {
		// TODO Auto-generated method stub
		view_back = v;
	}
